...
int main ()
{
    ...
    switch (a)
        ...
        case '2':
            ...
            if (y>x){ printf("o resultado da subtracao eh: %d", y-x);}
            if (x>y){ printf("o resultado da subtracao eh: %d", x-y);}
            else printf("o resultado da subtracao eh: 0");
            break;
        ...
        case '4':
           if (y>0 || y<0) printf(" o resultado da divisao dos dois numeros digitados eh: %d", x/y);
           if (y==0) { printf("nao eh possivel fazer essa conta");}
            break;
